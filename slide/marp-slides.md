...
<div class="member-card" style="padding: 12px;"><span class="chip">事務局長</span>
<div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 8px; margin: 1px 0 1px;"><h3 style="margin: 0; font-size: 0.9rem; line-height: 1.25; flex: 1;">助田 正樹（すけさん）</h3><img src="https://drsp.cc/assets/wp/sukeda.webp" style="width: 48px; height: 48px; border-radius: 50%; object-fit: cover; border: 1px solid #444; flex-shrink: 0;" alt="助田 正樹"></div>
